...
defined('DATABASE_NAME') ? NULL : define('DATABASE_NAME', 'theprocesssocialnetwork');
...
defined('MODEL_PATH') ? NULL : define('MODEL_PATH', 'model'.DS);
defined('VIEW_PATH') ? NULL : define('VIEW_PATH', 'view'.DS);
...
//require_once(DATA_PATH.'database.class.php');
//
